...
<html xmlns="https://www.w3.org/1999/xhtml">
	...
	<body style="margin:0px;">
		...
		<script type="text/javascript">
			/* Global variables used by the GPS Visualizer functions (20201019205755): */
			gv_options = {};
		...
		<script type="text/javascript">
			function GV_Map() {
				...
				gv_options.dynamic_data = [
					...
					<?php
    						$path_to_tracks = './';
    						if ($_REQUEST['track']) {$GPX_PATH = $path_to_tracks.$_REQUEST['track'].".gpx";}?>
					url:<?=$GPX_PATH?>,
			...
			// https://www.gpsvisualizer.com/map_input?form=leaflet&units=us
		</script>
